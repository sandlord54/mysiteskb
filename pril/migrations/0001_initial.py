# Generated by Django 2.1.7 on 2019-05-06 15:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('leading', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, related_name='leading', to='pril.Collect')),
                ('listeners', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='listeners', to='pril.Collect')),
            ],
        ),
        migrations.CreateModel(
            name='Template',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('namesobr', models.CharField(max_length=70, unique=True, verbose_name='Имя собрания')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collect',
            name='peopleincoll',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='peopleincoll', to='pril.Golos'),
        ),
    ]
